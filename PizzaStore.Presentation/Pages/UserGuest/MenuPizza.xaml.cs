...
namespace PizzaStore.Presentation.Pages
{
    ...
    /// </summary>
    public sealed partial class MenuPizza : Page
    {
        public MenuPizza()
        {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (e.Parameter != null && e.Parameter is Database)
            {
                ...
                MenuPizzaListView.ItemsSource = pizzas;
            }
        }
        private void MenuPizzaListView_Loaded(object sender, RoutedEventArgs e)
        {
            UpdateButtons();
        }
        ...
        private ProductType currentProductType = ProductType.Pizza;
        ...
        {
            ListView listView = FindName("MenuPizzaListView") as ListView;
            if (listView != null)
            {
