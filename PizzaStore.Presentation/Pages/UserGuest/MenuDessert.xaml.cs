...
namespace PizzaStore.Presentation.Pages
{
    ...
    /// </summary>
    public sealed partial class MenuDessert : Page
    {
        public MenuDessert()
        {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (e.Parameter != null && e.Parameter is Database)
            {
                ...
                MenuDessertListView.ItemsSource = desserts;
            }
        }
        private void MenuDessertListView_Loaded(object sender, RoutedEventArgs e)
        {
            UpdateButtons();
        }
        ...
        {
            ListView listView = FindName("MenuDessertListView") as ListView;
            if (listView != null)
            {
